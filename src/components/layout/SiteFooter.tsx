...
/**
 * Site footer with legal links. Renders at the end of the scrollable page
 * content — not pinned to the viewport — so it only appears when you reach
 * the bottom (or on short pages, sits below the main content).
 */
export function SiteFooter() {
  return (
    <footer className="mt-auto shrink-0 border-t border-white/10 bg-black/80">
      <div className="mx-auto w-full max-w-5xl px-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] pt-3 sm:px-6 sm:pt-3.5">
